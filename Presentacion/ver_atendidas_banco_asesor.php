            ...
            <div id="contenedorcito">
                ...
                <center>
                    <form action="guardar_fecha_correo_banco.php?id=1" method="post"><br><br>
                        ...
                        <center>
                            Exportar Solicitudes Atendidas <a class="exportacion"  href="ExpSolicitudesBancoAsesor.php?tipo=1&id=<?php echo $id; ?>"><img src="../images/excel.png" width="26" height="26"></img></a>                      </a>
                            <br/>
                            <br/>
                            <table id="demotable1" >
                                <thead><tr>
