...
//                }else{
                                    echo "<td width=\"15%\"><font face=\"verdana\">" .
                                    $fecha . '-' . '1' . '-' . '17076' . '-' . $row["ID_PLAN"] . '-P' . $row["ID_PROYECTO"] . "</font></td>";
//                }
                                    ...
                                    $e . "</font></td>";
                                    echo "<td width=\"\"><a href=\"./requerimientos_proyecto_n.php?proyecto=" . $row["ID_PROYECTO"] . "\" >
                                Asociar</a></td>";
                                    if ($treq[0] > 0) {
                                        echo "<td width=\"\"><a href=\"./cronograma_proyecto_n.php?proyecto=" . $row["ID_PROYECTO"] . "\" >
                                Asociar</a></td>";
                                    } else {
                                        echo "<td width=\"\">No Disponible</a></td>";
                                    }
                                    if ($tcron[0] > 0) {
                                        echo "<td width=\"\"><a href=\"./evaluadores_proyecto_n.php?proyecto=" . $row["ID_PROYECTO"] . "\" >
                                Asociar</a></td>";
                                    } else {
                                        echo "<td width=\"\">No Disponible</td>";
                                    }
                                    if ($teva[0] > 0) {
                                        echo "<td width=\"\"><a href=\"./candidatos_proyecto_n.php?proyecto=" . $row["ID_PROYECTO"] . "\" >
                                Asociar</a></td>";
                                    } else {
                                        echo "<td width=\"\">No Disponible</td>";
                                    }
                                    echo "<td width=\"\"><a href=\"./centros_proyecto_n.php?proyecto=" . $row["ID_PROYECTO"] . "\" >
                                Asociar</a></td>";
                                    echo "<td width=\"\"><a href=\"./verdetalles_proyecto_n.php?proyecto=" . $row["ID_PROYECTO"] . "\" TARGET=\"_blank\" >
