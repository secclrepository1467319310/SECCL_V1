    ...
    <head>
        ...
        <script language="javascript">
            function validar() {
                {
                    var correcto = true;
                    if (document.f2.obs.value == "")
                    {
                        window.alert("Digite las observaciones");
                        return false;
                    }
                }
            }
        ...
        <div id="cuerpo">
            <div id="contenedorcito" >
                <center><img src="../images/logos/sena.jpg" align="left" ></img>
                    <strong>FORMATO DE REGISTRO DE NOVEDAD</strong><br></br>

                    <form name="f2" onSubmit="return validar();" 
                          action="guardarnovedad_c.php" method="post" >
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <Select Name="tipo_novedad" >
                                        ...
                                        <?PHP
                                        $query2 = ("SELECT * FROM TIPO_NOVEDAD");
                                        $statement2 = oci_parse($connection, $query2);
                                        oci_execute($statement2);
                                        while ($row = oci_fetch_array($statement2, OCI_BOTH)) {
                                            $id_td = $row["ID_TIPO_NOVEDAD"];
                                            $doc = $row["TIPO_NOVEDAD"];
                            ...
                            <tr>
                                <th>Observaciones</th>
                                <td>
                                    <textarea rows="3" cols="50" name="obs" ></textarea>
                                </td>
                            </tr>
                        </table>
                        <br>
