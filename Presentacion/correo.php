    ...
    <body onload="inicio()">
        ...
        <div id="header" class="bck_lightgray">
            <div class="total">
                ...
                <div id="menu">
                    <ul id="nav">
                        <li class="top"><a href="http://certificados.sena.edu.co" class="top_link"><span>Correo</span></a></li>
        ...
        <div class="total" style="height: 680px;">
            ...
            <br></br>
            Si desea contactarnos a través de internet, puede hacerlo de acuerdo 
            con sus necesidades escribiendo a: 
            <a href="mailto:grupocertificacioncl@sena.edu.co">grupocertificacioncl@sena.edu.co</a>
        </div>
