                        ...
                        <center>
                            <table id="demotable1" >
                                <thead><tr>
                                        ...
                                        <th>Generar Sensibilización</th>
                                        <th>Portafolio Sensibilziación</th>
                                    </tr></thead>
                                <tbody>
                                </tbody>
                                ...
                                Consultar</a></td>";
                                    echo "<td width=\"\"><a href=\"./gen_sensibilizacion.php?proyecto=" . $row["ID_PROYECTO"] . "\" TARGET=\"_blank\">
                                Generar</a></td>";
                                    echo "<td width=\"\"><a href=\"./subir_sensibilizacion_c.php?proyecto=" . $row["ID_PROYECTO"] . "\" >
                                Soportes Sensibilización</a></td></tr>";
