...
<script type="text/javascript" src="../jquery/jquery.validate.mod.js"></script>
        <script type="text/javascript" src="js/val_misdatos_l.js"></script>
...
<!-- se modifica 10:22 a. m. 13/04/2015 para ahorrr código, sin embargo se deja comentado  
                  ...
                  <div id="tab2">
                    ...
                    <div id="tab3">
                        ...
                        <br>
                        <center>
                            <form name="cons2" id="cons" action="actualiza_pass.php" method="post" >
                                <table>
