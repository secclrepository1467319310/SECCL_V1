...
!-->
    <head>
        ...
        <script src="js/val_registrardetallesplan.js" type="text/javascript"></script>
            ...
            <br>
                ...
                <center><img src="../images/logos/sena.jpg" align="left" ></img>
                    ...
                    <table id="demotable1">
                        ...
                        <tr><th><strong>Código Regional:</strong></th><td><?php echo $reg[0];?></td><th><strong>Nombre Regional:</strong></th><td><?php echo utf8_encode($nomreg[0]) ?></td><th><strong>Fecha Elaboración:</strong></th><td><?php echo $fe[0]?></td><th><strong>Número Radicado:</strong></th><td><?php echo $fecha."-".$reg[0]."-".$cen[0]."-".$codiplan ?></td></tr>
                        <tr><th><strong>Código Centro:</strong></th><td><?php echo $cen[0];?></td><th><strong>Nombre Centro:</strong></th><td><?php echo utf8_encode($nomcen[0]) ?></td><th><strong>Nombre Subdirector:</strong></th><td><?php echo $prov?></td><th><strong>Nombre Responsable PECCL:</strong></th><td><?php echo $nom." ".$ape?></td></tr>
                ...
                <form name="f1" id="f1" onSubmit="return validarv();" method="post" 
                      action="guardardetalles.php?prov=<?php echo $prov ?>&tp=<?php echo $tp ?>" accept-charset="UTF-8">
                    ...
                    <br>
                        ...
                        <tr>
                            ...
                            <th rowspan="">Evaluaciones por Funcionarios</th>
...
//                                            echo "<td><input type=\"text\" size=\"2\" value=\"0\" name=\"per_total_func[]\"></input></td>";
                                            ...
                                            echo "<td><input type=\"text\" size=\"5\" value=\"0\" name=\"obs[]\"></input></td>";
                                            echo "<td><textarea name=\"det_pro_productivos[]\"></textarea></td></tr>";
                                        }
                ...
                <form name="f1" id="f1" onSubmit="return validarv();" method="post" 
                    ...
                    <br>
                        ...
                        <tr>
                            ...
                            <th rowspan="">Título NCL</th>
                            <th rowspan="">Elaborar Instrumentos</th>
                            <th rowspan="">Evaluaciones por Demanda Social</th>
                ...
                <form name="f1" id="f1" onSubmit="return validarv();" method="post" 
                    ...
                    <br>
                        ...
                        <tr>
                            ...
                            <th rowspan="">Título NCL</th>
                            <th rowspan="">Elaborar Instrumentos</th>
                            <th rowspan="">Evaluaciones por Alianza</th>
