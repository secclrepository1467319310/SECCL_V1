...
!-->
    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedor">
                <?php
                $query3 = ("SELECT CODIGO_REGIONAL FROM T_REGIONALES_USUARIOS where ID_USUARIO = '$id'");
                ...
                <center>
                    <form>
                        <a id="cleanfilters" href="#">Limpiar Filtros </a> || <a href="../Presentacion/registrar_instrumentador_c.php">Registrar Nuevo Instrumentador</a>
                        <br></br>
                        <center>
                            <table id="demotable1">
                                <thead>
                                ...
                                $query2 = "SELECT 
                                    ...
                                    ESTADO,
                                    DOCUMENTO
                                    FROM T_INSTRUMENTADORES INS join REGIONAL
                                    on INS.codigo_regional = regional.codigo_regional
                                    where INS.codigo_regional=$idc[0]
