...
//            if(!$regional){
            ...
            <center>
                ...
                $queryMetaRegional = ("SELECT T_METAS_REGIONALES.META_REGIONAL, REGIONAL.NOMBRE_REGIONAL, REGIONAL.CODIGO_REGIONAL FROM "
                        . "T_METAS_REGIONALES INNER JOIN REGIONAL ON T_METAS_REGIONALES.CODIGO_REGIONAL = REGIONAL.CODIGO_REGIONAL"
                        . " WHERE REGIONAL.CODIGO_REGIONAL = $regional");
                ...
                $queryMetaCentros = ("SELECT SUM(META) FROM CENTRO INNER JOIN T_METAS_CENTROS ON CENTRO.CODIGO_CENTRO = T_METAS_CENTROS.CODIGO_CENTRO  WHERE CODIGO_REGIONAL = $regional");
                ...
                echo "Meta por asignar: " . $metaActual . "<br><br>";
                ?>
            </center>
