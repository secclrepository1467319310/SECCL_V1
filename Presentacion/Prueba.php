...
and id_norma='$idn[0]' order by u.primer_apellido asc ";
                            ...
                            while ($row = oci_fetch_array($statement, OCI_BOTH)) {
                                ...
                                $query333 = ("select count(*) from T_NORMAS_REGULADAS where id_norma='$idn[0]'");
...
//                                    }
                                    ...
                                    if ($certificadoProyecto[0] >= 1) {
                                        ...
                                        $estadoCertificacion = 'Certificado en segundo intento en el proyecto P'.$certificadoNorma['ID_PROYECTO'];
                                    } else if ($estado[0] == 0) {
                                        $estadoCertificacion = 'No disponible';
