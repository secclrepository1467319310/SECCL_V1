    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center><?php echo '<font><strong>Solicitudes Devueltas</strong></font>'; ?></center>

                <br>
                <a id="cleanfilters" href="#">Limpiar Filtros</a>

                <center>
                    <form action="guardar_fecha_correo_banco.php?id=2" method="post"><br><br>
                        <center>
                            
                            <a href="?year=2015">Solicitudes devueltas del  2015</a>|
                            <a href="?year=2016">Solicitudes devueltas del  2016</a>
                             <br>
                            Exportar Solicitudes Devueltas <a class="exportacion" href="ExpSolicitudesBanco.php?tipo=4"><img src="../images/excel.png" width="26" height="26"></img></a>                      </a>
                            <br/>
                            <br/>
                            <table id="demotable1" >
                                <thead><tr>
                                ...
                                for ($i = 0; $i < $numrowsSelSolicitudes; $i++) {
                                    ...
                                    $sqlSelIdmax = 'SELECT ID_ESTADO_SOLICITUD
                                        ...
                                        WHERE ID_ESTADO_SOLICITUD IN (
                                            ...
                                            AND ID_TIPO_ESTADO_SOLICITUD = 4';
...
//                                    var_dump($rows222);
                                        ...
                                        echo "<td><font face=\"verdana\"><a href='datos_centro_mesa_solicitudes.php?rowsSelIdmax=" . $row["ID_OPERACION"] . "'>ver</a></font></td>";
                                        echo "<td><font face=\"verdana\">" .
                                        ...
                                        echo "<td><font face=\"verdana\"><a href='datos_observaciones_solicitudes.php?rowsSelIdmax=" . $rowsSelIdmax[ID_ESTADO_SOLICITUD][0] . "'>ver</a></td>";
                                        echo "<td>";
