...
!-->
    ...
    <body onload="inicio()">
        ...
        <div class="total" style="height: 680px;">
            <strong>Qué es la Evaluación de la Competencia Laboral?</strong>
            <br/><br/>
            <p align="justify">Es el proceso por medio del cual un evaluador recoge de una persona, 
                evidencias de su desempeño, producto y conocimiento, con el fin de 
                determinar si es competente, o aún no competente, para desempeñar 
                una función productiva. La evaluación de la competencia laboral se 
                centra en el desempeño real de las personas, soportado por evidencias 
                válidas y confiables con base en el referente que es la norma de 
                competencia laboral y no en potencialidades.</p>
            <br></br>
            <strong>Qué es la Certificación de la Competencia Laboral?</strong>
            <br/><br/>
            <p align="justify">Es el reconocimiento, por escrito, que hace un organismo certificador 
                a una persona que cumple con los requisitos establecidos en una 
                norma de competencia laboral, corroborándolo mediante evidencias
                de conocimiento, desempeño y producto.</p>
            <br/><br/>
            <br/><br/><br/>
            <center><img src="../images/imgquees.png" border="transparent" ></img></center><br />
            <br></br>
            <strong>¿Quiénes Pueden Acceder al Servicio?</strong>
            <br>
            <p align="justify">Todo Colombiano o extranjero que resida en nuestro 
                país mayor de 17 años de edad que sabe, conoce, 
                maneja y ha desempeñado como mínimo veinti cuatro(24)
                meses de experiencia en un oficio, labor, función 
                o actividad laboral y desea le sea reconocido por 
                un Organismo Certificador su Competencia.</p>
            <br />
        </div>
