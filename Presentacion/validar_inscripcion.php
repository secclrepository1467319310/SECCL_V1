...
!-->
    ...
    <body onload="inicio()">
        ...
        <div id="contenedorcito">
            ...
            if ($mensaje == 1) {
                ?>
                <div class="errorMensaje">Usted ya se encuentra preinscrito a una oferta</div>
            <?php } ?>
            <form class="proyecto" action="validar_cedula_oferta.php" method="POST">
                <fieldset style="text-align: left">
                    <legend><strong> Por favor Ingrese su numero de cedula </strong></legend>
                    <input type="text" name="nro_cedula" id="nro_cedula" />
                    <input type="hidden" name="id_oferta" id="id_oferta" value="<?php echo $id_oferta ?>" />
                    <input type="hidden" name="oferta" id="oferta" value="<?php echo $oferta ?>" />
