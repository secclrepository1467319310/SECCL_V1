...
$stmt = OCIParse($conn,"INSERT INTO PORTAFOLIO "
        . "(tipo_documento,descripcion,bin_data,filename,filesize,filetype,id_usuario) "
        . "VALUES ('$t_doc','$lob_description',EMPTY_BLOB(),'$lob_upload_name','$lob_upload_size','$lob_upload_type','$idc') returning BIN_DATA into :the_blob");
...
echo "<a href=portafolio_candidato.php?idc=$idc>Ver Documentos</a>";
}
else
{
...
OCILogoff($conn);
	...
	document.location.href='agregar_portafolio.php?idc=$idc'
	</script>
	";
}
?>