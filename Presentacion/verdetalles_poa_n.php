...
<html xmlns="http://www.w3.org/1999/xhtml" >
   ...
   function habilita(){ 
    document.getElementById("deta").disabled=false;
   } 
   ...
   function lim(){ 
    ...
    <body>
            ...
            while ($row = oci_fetch_array($statement, OCI_BOTH)) {
             ...
             $query5 = ("SELECT id_centro FROM centro_usuario where id_usuario =  '$id'");
                ...
                <table >
                    ...
                    <thead><tr><th><strong>Código Regional:</strong></th><td><?php echo "1" ?></td><th><strong>Nombre Regional:</strong></th><td><?php echo "DIRECCIÓN GENERAL" ?></td><th><strong>Fecha Elaboración:</strong></th><td><?php echo $fe[0]?></td><th><strong>Número Radicado:</strong></th><td><?php echo $codiplan2 ?></td></tr></thead>
                    <thead><tr><th><strong>Código Centro:</strong></th><td><?php echo "17076"?></td><th><strong>Nombre Centro:</strong></th><td><?php echo "GRUPO DE EVALUACIÓN Y CERTIFICACIÓN DE COMPETENCIAS LABORALES" ?></td><th><strong>Nombre Subdirector:</strong></th><td></td><th><strong>Nombre Responsable PECCL:</strong></th><td><?php echo $nom." ".$ape?></td></tr></thead>
        ...
        <div id="" >
            ...
            <form name="f1" id="f1" accept-charset="UTF-8" method="post">
                ...
                <table id='demotable1'>
                    ...
                    while ($row2 = oci_fetch_array($statement2, OCI_BOTH)) {
                        ...
                        if ($pro[0]>0) {
                          echo "<td><a id=\"deta\" name=\"deta\"  >No Disponible</a></td></tr>";  
                        }else{
                            echo "<td><a id=\"deta\" name=\"deta\" href=\"./registrar_proyecto_n.php?prov=" . $row2[ID_PROVISIONAL] . "\" >Generar Proyecto</a></td></tr>";
                        }
