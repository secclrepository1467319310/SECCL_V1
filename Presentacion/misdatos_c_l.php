...
<script type="text/javascript" src="../jquery/jquery.validate.mod.js"></script>
        <script type="text/javascript" src="js/val_misdatos_c_l.js"></script>
            ...
            <div id="contenedorcito">
                ...
                <div id="content"> 
                    <div id="tab1">
                        <br>
                        <center>
                            <form name="cons" id="cons" action="cons_candidato_l.php" method="post" >
                                <table>
			    ...
			    if($id!=null){
                            ...
                            <table>
                                ...
                                <tr><td><label>Nombres </label></td><td><?php echo utf8_encode($nombre) ?></td></tr>
                                <tr><td><label>Primer Apellido </label></td><td><?php echo utf8_encode($pape) ?></td></tr>
                                <tr><td><label>Segundo Apellido </label></td><td><?php echo utf8_encode($sape) ?></td></tr>
...
<tr><td><label>Modificar Ficha </label></td><td><a href="actualizar_ficha.php?id=<?php echo $id ?>" target="blank">Modificar Datos</a></td></tr>
 ...
 <!--10:32 a. m. 13/04/2015 se modifica para mejorar código, 
                   <div id="tab2">
                        <br>
                        <center>
                            <form name="cons" id="cons" class="cons_form" action="cons_candidato_l.php" method="post" >
                                <table>
                                    <tr><th>Documento</th><td><input type="text" name="documento"></input></td></tr>
                                </table>
                                <br><input type="submit" name="Consultar" value="Consultar"></input>
