        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center>
                    <form>
                        <br>
                        <a id="cleanfilters" href="#">Limpiar Filtros</a>   ||   <a  class="exportacion"  href="ExptotalesInstrumentos.php">Exportar a Excel<img src="../images/excel.png" width="26" height="26"></img></a>
                        <br></br>
                        <center>
                            <table id="demotable1" >
                                <thead><tr>
