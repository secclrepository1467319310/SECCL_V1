    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center>
                    <br>
                    <center><?php echo '<font><strong> Programacion 2015</strong></font>'; ?></center>
                    <br>
                    ...
                    <form action="" >
                        <center><table id='demotable1'>
                                ...
                                $fecha = '2015';
                                //PENDIENTE_OSCAR
                                $query = "SELECT ID_PLAN,ID_REGIONAL,ID_CENTRO,FECHA_ELABORACION,ID_PLAN FROM PLAN_ANUAL WHERE SUBSTR(FECHA_ELABORACION, 7,4) =2015 ";
                ...
                where id_plan = $row[ID_PLAN]");
                                    ...
                                    echo "<td width=\"\"><a href=\"./verdetalles_poa_c.php?plan=" . $row["ID_PLAN"] . "\" TARGET=\"_blank\">
