...
print "
	...
	document.location.href='adicionar_p_ev.php'
	</script>
	";
...
$stmt = OCIParse($conn,"INSERT INTO PORTAFOLIO_EVIDENCIAS "
        . "(id_proyecto,id_norma,grupo,id_candidato,tipo_documento,descripcion,bin_data,filename,filesize,filetype,id_usuario) "
        . "VALUES ('$proyecto','$norma','$grupo','$idca','$t_doc','$lob_description',EMPTY_BLOB(),'$lob_upload_name','$lob_upload_size','$lob_upload_type','$id') returning BIN_DATA into :the_blob");
...
echo "<a href=cargar_soportes_evidencias.php?idplan=$plan&grupo=$grupo&proyecto=$proyecto&norma=$norma&idca=$idca>Salir</a>";
//echo "<a href=plan_evidencias_ev.php>Salir</a>";
}
else
{
echo "Archivo No Cargado\n";
echo "<a href=cargar_soportes_evidencias.php?idplan=$plan&grupo=$grupo&proyecto=$proyecto&norma=$norma&idca=$idca>Volver</a>";
}
