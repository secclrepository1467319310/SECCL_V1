...
!-->
    ...
    <body onload="inicio()">
        ...
        <div id="contenedorcito">
                ...
                ?>
                <br>
                    <center><strong>Registrar Evaluador</strong></center>
                </br>

                <form name="formmapa" action="guardar_ev_c.php?proyecto=<?php echo $proyecto ?>" 
                    ...
                    <center><table id='demotable1'>
                                ...
                                <tr>
                                    ...
                                    <td><select name="tdoc"><option value="2">CC</option><option value="3">CE</option></select></td>    
                                </tr>
                                    <tr>
                                        <th>Número de Documento</th>
                                        <td><input name="documento" readonly id="documento" maxlength="15" onKeyPress="return validar(event)" type="text" value="<?php echo $_GET["documento"] ?>">
                                            </input></td>
                                    </tr>    
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="apellido" type="text" ></input></td>
                                    </tr>
                                    <tr>
                                        <th><label>Segundo Apellido</label></th>
                                        <td><input name="apellido2" type="text" ></input></td>
                                    </tr>
                                    <tr>
                                        <th><label>Celular</label></th>
                                        <td><input name="cel" type="text" ></input></td>
                                    </tr>
                                    <tr>
                            ...
                            <br></br>
                            <center><input name="send" type="submit" id="send" value="Guardar"></input></center>
                            <br></br>
                </form>
            </div>
        <div class="space">&nbsp;</div>
