...
!-->
    ...
    <body onload="inicio()">
        ...
        <div id="contenedorcito">
            ...
            ?>
            <ul id="tabs">
                <li><a href="#" title="tab1">Áreas Claves</a></li>
                            ...
                            <center>
                                <table id="demotable1" >
                                    <thead><tr>
                                            ...
                                            <th><strong>Editar Aprobación</strong></th>
                                        </tr></thead>
                                    <tbody>
                                    </tbody>
                                    ...
                                    where ac.id_area_clave='$idarea[0]' AND AC.PERIODO=2015";
                                    ...
                                    while ($row2 = oci_fetch_array($statement2, OCI_BOTH)) {
                                        ...
                                        if ($row2[OBS_ASESOR]==NULL) {
                                            echo "<td><a href=\"editar_areas_n.php?centro=$centro&idarea=$idarea[0]&iddeta=$row2[ID_AREAS_CENTRO]\"><img src=\"../images/editar.png\" alt=\"20\" width=\"20\"></a></td>";
                                    }else{
                                            echo "<td><a href=\"editar_areas_t_n.php?centro=$centro&idarea=$idarea[0]&iddeta=$row2[ID_AREAS_CENTRO]\"><img src=\"../images/editar.png\" alt=\"20\" width=\"20\"></a></td>";
                                        }   
    ...
    ORDER BY ID_PORTAFOLIO_AREAS DESC";
        ...
        Ver</a></td></tr>";
                        ...
                        <br>
                        <a href="agregar_soporte_onbase.php?centro=<?php echo $centro ?>&idarea=<?php echo $idarea[0] ?>"><strong>Adicionar Soporte Onbase</strong></a><br></br>
                        <br>
                        <table border="1" id="demotable1"  style="height:350px;width:920px;overflow:scroll;">
                            <thead><tr>
                                    <th><strong>Id</strong></th>
...
$query3 = "SELECT 
    ID_RESPUESTA,
    SOPORTE
    FROM RESPUESTA_AREAS_CLAVES WHERE ID_AREA='$idarea[0]'";
