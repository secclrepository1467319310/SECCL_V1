    ...
    <body onload="inicio()">
        ...
        <div id="contenedorcito">
            ...
            <div style="text-align: center">
                <img src="../images/texto_oferta_cor.jpg" />
                <img src="../images/cronograma_oferta_cor.jpg" />
                <br><br>
                <a href="oferta_funcionarios_cor.php" style="display: inline-block; border: 3px solid #d88637; text-align: center; padding: 5px; color: black; font-weight: bold; font-size: 20px; border-radius: 10px">Para conocer las NCL, mesas y centros designados<br>Haz clic aquí</a>
                <br><br>
                <div style="font-size: 15px">
                    "Un hombre puede tener éxito casi en cualquier cosa por la que tenga entusiasmo ilimitado.<br><b>Charles Schwab</b>"
                </div>
            </div>
        </div>
