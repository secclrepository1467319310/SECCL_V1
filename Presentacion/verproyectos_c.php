    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <a href="verproyectos_c_historico.php">Proyectos año 2015</a> || 
                <a href="verproyectos_c.php">Proyectos año 2016</a>
                        ...
                        <center>
                            <table id="demotable1" >
                                <thead><tr>
                                        ...
                                        <th>Requerimientos del Proyecto</th>
                                        <th>Cronograma de Actividades</th>
                                        <th>Actores del Proceso</th>
                                        <th>Cronograma Elaboración Ítems e Indicadores</th>
                                ...
                                while ($row = oci_fetch_array($statement, OCI_BOTH)) {
                                    ...
                                    $e . "</font></td>";
                                    ?>
                                    <td class="<?php echo $classDivProNac; ?>">
                                        <?php
                                        $selectObjetivo = "SELECT *
                                            FROM T_OBJETIVO_PROYECTO
                                            WHERE ID_PROYECTO = $row[ID_PROYECTO]";

                                        $objParseSelectObjetivo = oci_parse($connection, $selectObjetivo);
                                        $objExecuteSelectObjetivo = oci_execute($objParseSelectObjetivo, OCI_DEFAULT);
                                        $arraySelectObjetivo = oci_fetch_all($objParseSelectObjetivo, $rowSelectObjetivo);

                                        if ($arraySelectObjetivo == 1) {
                                            ?>
                                            Ya registrado
                                        <?php } else { ?>
                                            <a href="guardar_objetivo_proyecto.php?proyecto=<?php echo $row["ID_PROYECTO"]; ?>">Asociar</a>
                                        <?php } ?>
                                    </td>
                                    <td class="<?php echo $classDivProNac; ?>">
                                        <?php
                                        $selectImpacto = "SELECT *
                                            FROM T_IMPACTO_PROYECTO
                                            WHERE ID_PROYECTO = $row[ID_PROYECTO]";

                                        $objParseSelectImpacto = oci_parse($connection, $selectImpacto);
                                        $objExecuteSelectImpacto = oci_execute($objParseSelectImpacto, OCI_DEFAULT);
                                        $arraySelectImpacto = oci_fetch_all($objParseSelectImpacto, $rowSelectImpacto);

                                        if ($arraySelectImpacto == 1) {
                                            ?>
                                            Ya registrado
                                        <?php } else { ?>
                                            <a href="guardar_impacto_proyecto.php?proyecto=<?php echo $row["ID_PROYECTO"]; ?>">Asociar</a>
                                        <?php } ?>
                                    </td>
                                    <?php
                                    echo "<td width=\"\" class=\"$classDivProNac\"><a href=\"./requerimientos_proyecto_c.php?proyecto=" . $row["ID_PROYECTO"] . "\" >
                                        Asociar</a></td>";
                                    if ($treq[0] > 0) {
                                        echo "<td width=\"\" class=\"$classDivProNac\"><a href=\"./cronograma_proyecto_c.php?proyecto=" . $row["ID_PROYECTO"] . "\" >
                                            Asociar</a></td>";
                                    } else {
                                        echo "<td width=\"\" class=\"$classDivProNac\">No Disponible</a></td>";
                                    }
                                    ?>
                                    <td class="<?php echo $classDivProNac; ?>">
                                        ...
                                        <div class="divCelda">    
                                            ...
                                            if ($tcron[0] > 0) {
                                                ...
                                                echo "<a href=\"./evaluadores_proyecto_c.php?proyecto=" . $row["ID_PROYECTO"] . "\" >Asociar</a>";
                                            } else {
                                                echo "No Disponible";
                                            }
                                            ?>
                                        ...
                                        <div class="divCelda">    
                                            <?php
                                            if ($teva[0] > 0 && $estadoProyecto[ID_ESTADO_PROYECTO] != 4) {

                                                echo "<a href=\"./candidatos_proyecto_c.php?proyecto=" . $row["ID_PROYECTO"] . "\" >Asociar</a>";
                                            } else {
                                                echo "No Disponible";
                                            }
                                            ?>
                                    ...
                                    <?php
                                    echo "<td width=\"\" class=\"$classDivProNac\"><a href=\"./cronogramai_proyecto_c.php?proyecto=" . $row["ID_PROYECTO"] . "\" >
                                Asociar</a></td>";
                                    echo "<td width=\"\" class=\"$classDivProNac\"><a href=\"./cons_normas_proyecto_c.php?proyecto=" . $row["ID_PROYECTO"] . "$urlProNac\" >
                                Ver normas</a></td>";
                                    echo "<td width=\"\" class=\"$classDivProNac\"><a href=\"./verdetalles_proyecto_c2.php?proyecto=" . $row["ID_PROYECTO"] . "$urlProNac\" >
                                Ver Detalles</a></td>";
