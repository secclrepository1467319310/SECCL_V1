        ...
        <div id="">
            ...
            <div id="contenedorcito" >
                ...
                <center>
                    ...
                    <form id="registro" 
                          action="radicar_proyecto_c.php?proyecto=<?php echo $proyecto?>" method="post" >
                        <?php
...
&nbsp;&nbsp;&nbsp;establecido en esta Guía.  
                ...
                ?>
                        ...
                        ?><tr><th colspan="2">OTROS COMPROMISOS</th><td><textarea name="compromisos" readonly disabled rows="5" cols="80"><?php echo $comp[0] ?></textarea></td></tr>
                        <?php
                                }else{
