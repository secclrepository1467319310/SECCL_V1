    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                $queryActa = ("SELECT NOMBRE, T_ID_ACTA FROM T_ACTA where T_ID_ACTA =  $id_acta");
                ...
                <center>
                    ...
                    <form action="acta_crear_area.php" method="POST" >
...
//Cuando se active el rol general se aplica este querty
                                $query = "SELECT CENTRO.NOMBRE_CENTRO, CENTRO.CODIGO_CENTRO, "
                                        . "REGIONAL.NOMBRE_REGIONAL, REGIONAL.CODIGO_REGIONAL FROM T_REGIONALES_USUARIOS "
...
//                            $query = "SELECT CODIGO_REGIONAL,CODIGO_CENTRO,NOMBRE_CENTRO FROM CENTRO ORDER BY CODIGO_REGIONAL ASC";
                                ...
                                while ($row = oci_fetch_array($statement, OCI_BOTH)) {
                                    ...
                                    echo "<td width=\"\"><font face=\"verdana\"> <input type=\"checkbox\" name=\"centro[]\" value=\"$row[CODIGO_CENTRO]\">";
