...
!-->
    <head>
        ...
        <script src="js/val_informe_cualitativo.js" type="text/javascript"></script>
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center>
                    ...
                    <form class="proyecto" method="post" action="guardar_mod_inf_cualitativo.php" id="form_informe_cualitativo">
                        <input id="plan" name="plan" type="hidden" value="<?php echo $id_plan ?>" />
                        <input id="id_informe" name="id_informe" type="hidden" value="<?php echo $informe['ID_INFORME'] ?>" />
                        ...
                        <fieldset style="text-align: left">
                            ...
                            <div class="textoValidar">
                                ...
                                <textarea name="fort_conocimiento" id="fort_conocimiento" style="width:800px; height: 100px"><?php echo $informe['FORTALEZAS_CONOCIMIENTO'] ?></textarea>
                            </div>
                            <br><br>
                            Debilidades Comunes
                            <br>
                            <div class="textoValidar">
                                ...
                                <textarea name="deb_conocimiento" id="deb_conocimiento" style="width:800px; height: 100px"><?php echo $informe['DEBILIDADES_CONOCIMIENTO'] ?></textarea>
                            </div>
                        </fieldset><br><br>
                        ...
                        <fieldset style="text-align: left">
                            ...
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="fort_desempeno" id="fort_desempeno" style="width:800px; height: 100px"><?php echo $informe['FORTALEZAS_DESEMPENO'] ?></textarea>
                            </div>
                            <br><br>
                            Debilidades Comunes
                            <br>
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="deb_desempeno" id="deb_desempeno" style="width:800px; height: 100px"><?php echo $informe['DEBILIDADES_DESEMPENO'] ?></textarea>
                            </div>
                        </fieldset><br><br>
                        ...
                        <fieldset style="text-align: left">
                            ...
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="fort_producto" id="fort_producto" style="width:800px; height: 100px"><?php echo $informe['FORTALEZAS_PRODUCTO'] ?></textarea>
                            </div>
                            <br><br>
                            Debilidades Comunes
                            <br>
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="deb_producto" id="deb_producto" style="width:800px; height: 100px"><?php echo $informe['DEBILIDADES_PRODUCTO'] ?></textarea>
                            </div>
                        </fieldset><br><br>
                        ...
                        <fieldset style="text-align: left">
                            ...
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="opor_mejor_produc" id="opor_mejor_produc" style="width:800px; height: 100px"><?php echo $informe['OPORT_MEJORA_PRODUCTIVO'] ?></textarea>
                            </div>
                        </fieldset><br><br>
                        ...
                        <fieldset style="text-align: left">
                            ...
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="asp_resal_produc" id="asp_resal_produc" style="width:800px; height: 100px"><?php echo $informe['ASPECT_MEJORA_PROC'] ?></textarea>
                            </div>
                        </fieldset><br><br>
                        <div style="text-align: left">
                            ¿Tiene una historia de vida de un candidato a resaltar?<br>
                            <?php if ($informe['HISTORIA'] == 0){ ?>
                            <input type="radio" name="historia" class="historia" value="1"/>SI
                            <input type="radio" name="historia" class="historia" value="0" checked="checked"/>NO
                            <?php }else{ ?>
                            <input type="radio" name="historia" class="historia" value="1" checked="checked"/>SI
                            <input type="radio" name="historia" class="historia" value="0"/>NO
                            <?php } ?>
                            <br><br>
                        </div>
                        <fieldset style="text-align: left" id="contenedorHistoria">
                            ...
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="historia_vida" id="historia_vida" style="width:800px; height: 100px"><?php echo $informe['HISTORIA_VIDA'] ?></textarea>
                            </div>
                        </fieldset>
                        <br>
