...
!-->
	...
	<?php include ('layout/cabecera.php') ?>
        ...
        <div id="contenedorcito">
                ...
                <br></br>
<!--                <form action="guardar_documento_ev.php" method="post" enctype="multipart/form-data">
                    <table>
...
//                                WHERE (ID_TDOC_PORTAFOLIO NOT IN (20,18,15,17,19,21,22,23,24,25,26))");
...
//                                }
                  ...
                  <br><a href=consultar_p_ev.php>ver Portafolio</a>
                  </center>
                  <br></br>
               </div>
        <div class="space">&nbsp;</div>
