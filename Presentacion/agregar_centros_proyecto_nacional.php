        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                <center>
                    ...
                    <form id="frmCentrosProyectoNacional" action="guardar_centros_proyecto_nacional.php" method="post">
                        ...
                        <center><table id='demotable1'>
                                ...
                                <?php
                                $query = "SELECT PA.ID_PLAN, CE.CODIGO_CENTRO, CE.NOMBRE_CENTRO, REG.CODIGO_REGIONAL, REG.NOMBRE_REGIONAL 
                                    FROM PLAN_ANUAL PA 
                                    INNER JOIN CENTRO CE 
                                        ON PA.ID_CENTRO = CE.CODIGO_CENTRO 
                                    INNER JOIN REGIONAL REG 
                                        ON CE.CODIGO_REGIONAL = REG.CODIGO_REGIONAL 
                                    WHERE SUBSTR(PA.FECHA_ELABORACION, 7,4) = 2016 
                                    AND PA.ID_CENTRO NOT IN (
                                        SELECT PRO.ID_CENTRO
                                        FROM T_PROY_NAC_PROYECTO PNP
                                        ...
                                        WHERE TPN.ID_PROYECTO_NACIONAL = '$_GET[proNac]')
                                    ORDER BY REG.CODIGO_REGIONAL ASC";
                                ...
                                while ($row = oci_fetch_array($statement, OCI_BOTH)) {
                                    ...
                                    echo "<td width=\"\"><input type=\"checkbox\" name=\"idPlanes[]\" value=\"$row[ID_PLAN]\" /> </td></tr>";
