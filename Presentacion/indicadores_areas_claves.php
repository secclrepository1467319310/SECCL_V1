...
!-->
    ...
    <body onload="inicio()">
        ...
        <div style="width:900px; margin: 0 auto;">
            ...
            ?>
            <center>
                <strong>Areas Claves Regionales</strong><br></br>
            </center>
            ...
            <center>
                <table id="demotable">
                    ...
                    $query = ("SELECT REGIONAL.NOMBRE_REGIONAL, REGIONAL.CODIGO_REGIONAL, T_ACTA.T_ID_ACTA FROM 
                    REGIONAL INNER JOIN T_ACTA ON REGIONAL.CODIGO_REGIONAL = T_ACTA.CODIGO_REGIONAL");
                    ...
                    while ($centros = oci_fetch_array($statement, OCI_BOTH)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="visualizar_acta.php" method="POST">
                                    <?php
                                    ?>
                                    <input type="hidden" name="id_acta" value="<?php echo $centros['T_ID_ACTA'] ?>" />
