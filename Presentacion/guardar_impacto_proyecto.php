    ...
    <body>
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center>
                    <br>
                    <center><?php echo '<font><strong>Impacto del Proyecto</strong></font>'; ?></center>
                    </br>
                    <form id="frmFormulario" action="guardar_impacto_proyecto_2.php" method="post">
                        <br>
                        <br></br>
                        <center>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <th colspan="3">Percepción del Impacto del Proceso en la Región</th>
                                    </tr>
                                    <tr>
                                        <td colspan="3" style=" height: 100px;" class="<?php echo $classDivProNac; ?>">
                                            <textarea id="txtImpacto" name="txtImpacto" maxlength="200" style=" width: 99.5%; height: 85%; "></textarea>
