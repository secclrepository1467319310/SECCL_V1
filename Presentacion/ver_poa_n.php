        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center>
                    ...
                    <form action="" >
                        <center><table id='demotable1'>
                                ...
                                <?php
                                $fecha = date('Y');
                                $query = "SELECT ID_PLAN,FECHA_ELABORACION,ID_PLAN FROM PLAN_ANUAL where ID_CENTRO='117' OR USU_REGISTRO='$id'";
                ...
                where id_plan = $row[ID_PLAN]");
                                    ...
                                    $fecha . '-' . '1' . '-' . '17076' . '-' . $row["ID_PLAN"] . "</font></td>";
                                    echo "<td width=\"\"><font face=\"verdana\">" .
                                    $row["FECHA_ELABORACION"] . "</font></td>";
                                    echo "<td width=\"\"><font face=\"verdana\">" .
                                    $row["FECHA_ELABORACION"] . "</font></td>";
                                    echo "<td width=\"\"><a href=\"./asociar_ncl_n.php?unidad=1&plan=" . $row["ID_PLAN"] . "\" >
                                Asociar</a></td>";
                                    echo "<td width=\"\"><a href=\"./verdetalles_poa_n.php?plan=" . $row["ID_PLAN"] . "\" TARGET=\"_blank\">
