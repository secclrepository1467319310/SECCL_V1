...
echo "<a href=carga_ce_laboral.php?grupo=$grupo&proyecto=$proyecto&norma=$norma&idca=$idca>Salir</a>";
//echo "<a href=plan_evidencias_ev.php>Salir</a>";
}
else
{
echo "Archivo No Cargado\n";
echo "<a href=carga_ce_laboral.php?grupo=$grupo&proyecto=$proyecto&norma=$norma&idca=$idca>Volver</a>";
}
