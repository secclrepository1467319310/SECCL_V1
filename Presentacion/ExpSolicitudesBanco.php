...
header("Content-Disposition: attachment; filename=Reporte$repo-ADMINISTRADOR.$_GET[fechainicial]-$_GET[fechafinal].xls");
...
if($_GET[fechainicial]=="" ||$_GET[fechafinal]=="" ){
    ...
    $where="and tes.FECHA_REGISTRO BETWEEN '".$_GET[fechainicial]."' AND '".$_GET[fechafinal]."' ";
}
?>
