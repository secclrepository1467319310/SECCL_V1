    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center><?php echo '<font><strong>Solicitudes En Revisión</strong></font>'; ?></center>
                ...
                <center>
                    <form><br><br>
                        <a href="?year=2015">Solicitudes en revision del  2015</a>|
                        <a href="?year=2016">Solicitudes en revision del  2016</a>
                        <br>
                        <center>
                            Exportar Solicitudes En Revisión <a  class="exportacion"  href="ExpSolicitudesBanco.php?tipo=3"><img src="../images/excel.png" width="26" height="26"></img></a>                      </a>
                            <br/>
                            <br/>
                            <table id="demotable1" >
                                <thead><tr>
                                ...
                                for ($i = 0; $i < $numrowsSelSolicitudes; $i++) {
                                    ...
                                    $sqlSelIdmax = 'SELECT ID_ESTADO_SOLICITUD
                                        ...
                                        WHERE ID_ESTADO_SOLICITUD IN (
                                            ...
                                            AND ID_TIPO_ESTADO_SOLICITUD = 3';
