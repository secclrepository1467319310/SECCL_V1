        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                <center>
                    ...
                    <form action="" >
                        <center><table id='demotable1'>
                                ...
                                <?php
                                $fecha = date('Y');
                                $query = "SELECT ID_PLAN,ID_REGIONAL,ID_CENTRO,FECHA_ELABORACION,ID_PLAN FROM PLAN_ANUAL";
                ...
                where id_plan = $row[ID_PLAN]");
                                    ...
                                    echo "<td width=\"\"><a href=\"./consultar_areas_n.php?centro=" . $row["ID_CENTRO"] . "\" TARGET=\"_blank\">
                                Ver áreas</a></td></tr>";
                                    $numero++;
                                }
