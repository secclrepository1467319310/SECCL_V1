...
//                    echo '</pre>';
                    ...
                    do
                    {
//                      echo '<hr/> Aspirantes Registrados: <hr/>' .
                        $sqlCan = 'SELECT '
                                . 'COUNT(CAN.ID_CANDIDATO) AS ASPIRANTES_REGISTRADOS  '
                                . 'FROM CANDIDATOS_PROYECTO CAN '
                                . "WHERE CAN.ID_PROYECTO = {$rowProyNaReg['ID_PROYECTO'][$ProyNaR]} "
                                . 'ORDER BY '
                                . ' CAN.ID_CANDIDATO ASC';
                        $objCan = oci_parse($connection, $sqlCan);
                        oci_execute($objCan);
//                      echo '  // Numero Registros: ' .
                        $numRowsCan = oci_fetch_all($objCan, $rowCan);
...
//                        echo '<hr/> Personas Certificadas: <hr/>' .
                        $sqlCert = 'SELECT '
                                . ' COUNT(CERT.ID_CANDIDATO) AS CERTIFICACIONES_EXPEDIDAS, '
...
//                                  echo '</pre>';
                        ...
                        <tr>
                            ...
                            <td <?php echo $classRegistros; ?>>
                                <?php echo $rowCan['ASPIRANTES_REGISTRADOS'][$Reg]; ?>
                            </td>
                            <td <?php echo $classRegistros; ?>>
                                <?php echo $rowIns['CANDIDATOS_INSCRITOS'][$Reg]; ?>
                            </td>
                            <td <?php echo $classRegistros; ?>>
                                <?php echo $rowIns['PERSONAS_INSCRITAS'][$Reg]; ?>
                            </td>
                            <td <?php echo $classRegistros; ?>>
                                <?php echo $rowIns['CANDIDATOS_INSCRITOS'][$Reg] - $rowEva['EVALUACIONES_REALIZADAS'][$Reg]; ?>
                            </td>
                            <td <?php echo $classRegistros; ?>>
                                <?php echo $rowIns['PERSONAS_INSCRITAS'][$Reg] - $rowEva['PERSONAS_EVALUADAS'][$Reg]; ?>
                            </td>
                            <td <?php echo $classRegistros; ?>>
                                <?php echo $rowEva['EVALUACIONES_REALIZADAS'][$Reg]; ?>
                            </td>
                            <td <?php echo $classRegistros; ?>>
                                <?php echo $rowEva['PERSONAS_EVALUADAS'][$Reg]; ?>
                            </td>
                            <td <?php echo $classRegistros; ?>>
                                <?php echo $rowCert['CERTIFICACIONES_EXPEDIDAS'][$Reg]; ?>
                            </td>
                            <td <?php echo $classRegistros; ?>>
