...
header("Content-Disposition: attachment; filename=Reporte Proyectos Nacionales (Corte $fe H$h M$m).xls");
...
//                    . 'WHERE ProyNa.ID_PROYECTO_NACIONAL = 102'
                    ."where extract(year from  FECHA_REGISTRO)='2016'"
                    . 'ORDER BY '
...
//                                  echo '</pre>';
                        ...
                        <tr>
                            ...
                            <td <?php echo $classRegistros; ?>>
                                <?php echo $rowEva['EVALUACIONES_REALIZADAS'][$Reg]-$rowCert['CERTIFICACIONES_EXPEDIDAS'][$Reg]; ?>
                            </td>
                            <td <?php echo $classRegistros; ?>>
