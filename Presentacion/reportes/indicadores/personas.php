...
header("Content-Disposition: attachment; filename=Consolidado INS-PEV-EVA-PCE-CER Personas REG-CEN (Corte $fe H$h M$m).xls");
...
//                        echo '</pre>';
					...
					<tr>
						...
						<td <?php echo $classRegistros; ?>>
							<?php echo ($rowIns['PERSONAS_INSCRITAS'][0] + $datosNCCERIns['PERSONAS_INSCRITAS'][0]) - ($rowEva['PERSONAS_EVALUADAS'][0] + $datosNCCEREva['PERSONAS_EVALUADAS'][0]); ?>
						</td>
						<td <?php echo $classRegistros; ?>>
							<?php echo ($rowEva['PERSONAS_EVALUADAS'][0] + $datosNCCEREva['PERSONAS_EVALUADAS'][0]); ?>
						</td>
						<td <?php echo $classRegistros; ?>>
							<?php echo ($rowEva['PERSONAS_EVALUADAS'][0] + $datosNCCEREva['PERSONAS_EVALUADAS'][0]) - ($rowCer['PERSONAS_CERTIFICADAS'][0] + $datosNCCERCer['PERSONAS_CERTIFICADAS'][0]); ?>
						</td>
						<td <?php echo $classRegistros; ?>>
