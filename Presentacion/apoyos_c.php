    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedor">
                ...
                <center>
                    <form>
                        <a id="cleanfilters" href="#">Limpiar Filtros </a> || <a href="../Presentacion/registrar_apoyo_c.php">Registrar Nuevo Apoyo</a>
                        <br></br>
                        <center>
                            <table id="demotable1">
                                <thead>
                                ...
                                $query2 = "SELECT 
                                    ...
                                    where apoyos.codigo_centro=$cen[0]
                                ...
                                while ($row2 = oci_fetch_array($statement2, OCI_BOTH)) {
                                    ...
                                    if ($row2[ESTADO] == 1) {
                                        ...
                                        echo "<td width=\"\"><a href=\"./cambio_estado_apoyo.php?es=0&ida=" . $row2["DOCUMENTO"] . "\" >
                                        Inactivar</a></td></tr>";
                                    } else {
                                        echo "<td width=\"\">Inactivo</td>";
                                        echo "<td width=\"\"><a href=\"./cambio_estado_apoyo.php?es=1&ida=" . $row2["DOCUMENTO"] . "\" >
                                        Activar</a></td></tr>";
                                    }
