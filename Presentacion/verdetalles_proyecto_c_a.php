                        ...
                        <table id="demotable1">
                            ...
                            while ($row3 = oci_fetch_array($statement3, OCI_BOTH))
                            {
                                ...
                                while ($row = oci_fetch_array($statement, OCI_BOTH))
                                {
                                    ...
                                    if ($_SESSION["rol"] == "13")
                                    {
                                        echo "<td width=\"\"><a href=\"./consultar_grupo_adm.php?norma=$row3[ID_NORMA]&proyecto=" . $proyecto . "\" >
                                Consultar</a></td></tr>";
                                    }
                                    else
                                    {
                                        echo "<td width=\"\"><a href=\"./consultar_grupo_a.php?norma=$row3[ID_NORMA]&proyecto=" . $proyecto . "\" >
                                Consultar</a></td></tr>";
                                    }
                                    $numero3++;
                                }
