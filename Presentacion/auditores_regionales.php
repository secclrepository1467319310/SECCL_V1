...
//                $query2 = ("SELECT codigo_centro FROM centro  where id_centro =  '$idc[0]'");
                ...
                <center>
                    <form>
                        <a id="cleanfilters" href="#">Limpiar Filtros </a> || <a href="../Presentacion/registrar_auditores_regionales.php">Registrar Nuevo Auditor</a>
                        <br></br>
                        <center>
                            <table id="demotable1">
                                <thead>
                               ...
                               $query2 = "SELECT 
                                    ...
                                    where auditor.codigo_centro='0' and auditor.codigo_regional=$cen[0]
