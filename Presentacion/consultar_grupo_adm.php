                    ...
                    <fieldset>
                        ...
                        <table id="demotable1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $query22 = ("select unique n_grupo from proyecto_grupo where id_proyecto='$proyecto' and id_norma='$idnorma'");

                                    $statement22 = oci_parse($connection, $query22);
                                    oci_execute($statement22);

                                    $row = oci_fetch_all($statement22, $rowStam);
                                    if ($row >= 1)
                                    {
                                    ?>
                                        <Select Name="grupo" style=" width:150px" onChange="this.form.submit()" >
                                            <?PHP
                                            for ($rowR = 0; $rowR < $row; $rowR++)
                                            {
                                                $id_m = $rowStam["N_GRUPO"][$rowR];
                                                echo "<OPTION>", "Seleccione", "</OPTION>";
                                                echo "<OPTION value=" . $id_m . ">", $rowStam["N_GRUPO"][$rowR], "</OPTION>";
                                            }
                                            ?>
                                        </Select>
                                    <?php
                                    ...
                                    {
                                        echo "No hay grupos creado para este proyecto/norma";
                                    }
                                    ?>
                                </td>
                            </tr>
