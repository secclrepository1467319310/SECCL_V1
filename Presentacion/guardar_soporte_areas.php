...
$stmt = OCIParse($conn,"INSERT INTO PORTAFOLIO_AREAS "
        . "(id_area,tipo_documento,descripcion,bin_data,filename,filesize,filetype,id_usuario) "
        . "VALUES ('$idarea','$t_doc','$lob_description',EMPTY_BLOB(),'$lob_upload_name','$lob_upload_size','$lob_upload_type','$id') returning BIN_DATA into :the_blob");
...
echo "<a href=menumisional.php>Consultar</a>";
}
else
{
...
OCILogoff($conn);
	...
	document.location.href='cargar_soporte_area.php?idarea=$idarea'
	</script>
	";
}
?>