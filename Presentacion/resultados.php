...
!-->
    ...
    <body onload="inicio()">
        ...
        <div id="contenedor">
            <br>
            <center><h2>Resultados de las Encuestas aplicadas a los candidatos participantes de procesos de ECCL</h2></center>
            <br>
            <div id="portapdf"> 
                <object data="Documentos/Publicacion.pdf" type="application/pdf" width="100%" height="100%"></object> 
            </div> 
        </div>
