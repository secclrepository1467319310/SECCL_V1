...
$mail->Subject = "Cuenta de correo Creada Satisfactoriamente - SECCL";
...
{left:90px; top:-4px; background: #fff; padding:3px; border:1px solid #3a93d2; white-space:nowrap; width:90px; z-index:400; height:auto;}
    ...
    <body>
        ...
        <div id="">
            ...
            <strong> Registro de Usuario</strong><br></br>
            <br></br>
            ...
            <!-- CONTINUA -->
            <center><strong>NOTA: Este es un correo automático, favor no responder.</strong></center>
            <div class="total margen" style="margin-top:10px; height: 50px;">
                <div class="izq">
                    <div class="cuadro">
                        ...
                        <div class="font18 jade bold margen_lados verdana"><img src="../images/transferencia.jpg" alt="Certificado Digital" /> Bienvenido '.$nom.' '.$ape.'</div>

                        <div class="font14 margen" style="margin-right:10px;">
                            <br />
                            Se ha registrado con Éxito en el Sistema de Evaluación y Certificación de Competencias Laborales - SECCL</br>
                            Su usuario y contraseña son: </br>
                            <strong>Usuario :</strong> '.  $user .' <br></br>
                            <strong>Contraseña :</strong> ' . $pas .' <br></br>
                            Agradecemos guardar y tener presente este registro para acceder a la información que allí se 
                            disponga e interactuar con la página.</br>
                        </div>
