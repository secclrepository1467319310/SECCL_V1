    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center>
                    <br>
                    <center><?php echo '<font><strong>Proyectos Generados 2015</strong></font>'; ?></center>
                    </br>
                    <form>
                        <br>
                        ...
                        <center>
                            <table id="demotable1" >
                                ...
                                <?php
                                $fecha = '2015';
                                $query = "SELECT ID_PROYECTO,FECHA_ELABORACION,NIT_EMPRESA,ID_PLAN FROM PROYECTO where ID_CENTRO='$cen[0]' AND SUBSTR(FECHA_ELABORACION, 7,4) = 2015";
                                ...
                                Ver normas</a></td>";
                                    echo "<td width=\"\"><a href=\"./verdetalles_proyecto_c2.php?proyecto=" . $row["ID_PROYECTO"] . "\" >
