...
!-->
    ...
    <body onload="inicio()">
        ...
        <div id="contenedorCITO">
            ...
            <center>
                <br>
                <strong>Fecha de Corte : 30 de Diciembre de 2015</strong>
                </br>
                <form>
                    <br>
...
<!--                                    <th><strong>Total Certificados Funcionarios</strong></th>
                                    ...
                                    <th><strong>Meta Certificados Generados (2015)</strong></th>
                                    <th><strong>(%) de Cumplimiento</strong></th>
                                    <th><strong>Total Personas Certificadas</strong></th>
                                    <th><strong>Meta Personas Certificadas (2015)</strong></th>
                                    <th><strong>(%) de Cumplimiento</strong></th>
