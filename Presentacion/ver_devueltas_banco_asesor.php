    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center>
                    <form action="guardar_fecha_correo_banco.php?id=1" method="post"><br><br>
                        <input type="hidden" name="redirec" value="1"/>
                        <center>
                            Exportar Solicitudes Devueltas <a class="exportacion" href="ExpSolicitudesBancoAsesor.php?tipo=4&id=<?php echo $id; ?>"><img src="../images/excel.png" width="26" height="26"></img></a>                      </a>
                            <br/>
                            <br/>
                            <table id="demotable1" >
                                <thead><tr>
                                ...
                                $sqlSelSolicitudes = "SELECT DISTINCT TES.ID_SOLICITUD 
                                        ...
                                        WHERE SA.USUARIO_ASIGNADO = '$id' AND SA.ESTADO = '1'
