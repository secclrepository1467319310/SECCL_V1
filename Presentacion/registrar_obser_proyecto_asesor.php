        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                <center>
                    ...
                    <form id="frmFormulario" action="guardar_obser_proyecto_asesor.php" method="post">
                        <br></br>
                        <center>
                            <table>
                                <tr>
                                    <th>Observaciones del proceso</th>
                                </tr>
                                <tr>
                                    <td style=" height: 100px; width: 500px;" class="<?php echo $classDivProNac; ?>">
                                        <textarea id="txtImpacto" name="txtImpacto"  style=" width: 99.5%; height: 85%; "></textarea>
