...
<script type="text/javascript">
    window.location = "../Presentacion/misdatos_c_l.php?id=<?php echo $idc[0] ?>&documento=<?php echo $documento ?>&nombre=<?php echo $nombre[0] ?>&pape=<?php echo $pape[0] ?>&sape=<?php echo $sape[0] ?>";
</script>
