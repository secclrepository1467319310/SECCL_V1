        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center>
                    ...
                    <form class="proyecto" method="POST" action="guardar_informe_cualitativo.php" id="form_informe_cualitativo">
                        ...
                        <fieldset style="text-align: left">
                            ...
                            <div class="textoValidar">
                                ...
                                <textarea name="fort_conocimiento" id="fort_conocimiento" style="width:800px; height: 100px" maxlength="500"></textarea>
                            </div>
                            <br><br>
                            Debilidades Comunes
                            <br>
                            <div class="textoValidar">
                                ...
                                <textarea name="deb_conocimiento" id="deb_conocimiento" style="width:800px; height: 100px" maxlength="500"></textarea>
                            </div>
                        </fieldset><br><br>
                        ...
                        <fieldset style="text-align: left">
                            ...
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="fort_desempeno" id="fort_desempeno" style="width:800px; height: 100px" maxlength="500"></textarea>
                            </div>
                            <br><br>
                            Debilidades Comunes
                            <br>
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="deb_desempeno" id="deb_desempeno" style="width:800px; height: 100px" maxlength="500"></textarea>
                            </div>
                        </fieldset><br><br>
                        ...
                        <fieldset style="text-align: left">
                            ...
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="fort_producto" id="fort_producto" style="width:800px; height: 100px" maxlength="500"></textarea>
                            </div>
                            <br><br>
                            Debilidades Comunes
                            <br>
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="deb_producto" id="deb_producto" style="width:800px; height: 100px" maxlength="500"></textarea>
                            </div>
                        </fieldset><br><br>
                        ...
                        <fieldset style="text-align: left">
                            ...
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="opor_mejor_produc" id="opor_mejor_produc" style="width:800px; height: 100px" maxlength="500"></textarea>
                            </div>
                        </fieldset><br><br>
                        ...
                        <fieldset style="text-align: left">
                            ...
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="asp_resal_produc" id="asp_resal_produc" style="width:800px; height: 100px" maxlength="500"></textarea>
                            </div>
                        </fieldset><br><br>
                        ...
                        <fieldset style="text-align: left; display: none" id="contenedorHistoria">
                            ...
                            <div class="textoValidar">
                                <label class="cantidad" id="cantidad2" style="color: red;"></label>
                                <textarea name="historia_vida" id="historia_vida" style="width:800px; height: 100px" maxlength="500"></textarea>
                            </div>
                        </fieldset>
                        <br>
