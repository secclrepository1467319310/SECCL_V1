                ...
                <center>
                    <form action="" >
                        <center><table id='demotable1'>
                                ...
                                <?php
                                $fecha = date('Y');
                                $query = "SELECT ID_PLAN,FECHA_ELABORACION,ID_PLAN FROM PLAN_ANUAL where ID_CENTRO='$cen[0]' AND SUBSTR(FECHA_ELABORACION, 7,4) = 2016";
                                ...
                                while ($row = oci_fetch_array($statement, OCI_BOTH)) {
                                    ...
                                    echo "<td width=\"\"><font face=\"verdana\">" .
                                    $max[0] . "</font></td>";
                                    echo "<td width=\"\"><a href=\"./verdetalles_poa_a.php?plan=" . $row["ID_PLAN"] . "\" TARGET=\"_blank\">
