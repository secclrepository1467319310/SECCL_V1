        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center>
                    <form><br><br>
                        <center>
                            Exportar Solicitudes Pendientes <a class="exportacion" href="ExpSolicitudesBancoAsesor.php?tipo=2&id=<?php echo $id; ?>"><img src="../images/excel.png" width="26" height="26"></img></a>                      </a>
                            <br/>
                            <br/>
                            <table id="demotable1" >
                                <thead><tr>
