                        ...
                        <center>
                            <table id="demotable1" >
                                <thead><tr>
                                        ...
                                        <th>Generar Inducción</th>
                                        <th>Portafolio Inducción</th>
                                    </tr></thead>
                                <tbody>
                                </tbody>
                                ...
                                $q2 = "select unique EP.id_proyecto from evaluador_proyecto EP INNER JOIN PROYECTO P ON EP.ID_PROYECTO = P.ID_PROYECTO where EP.id_evaluador=$doceva[0] AND SUBSTR(P.FECHA_ELABORACION,7,4) = 2016";
                                ...
                                Generar</a></td>";
                                        echo "<td width=\"\"><a href=\"./subir_induccion_ev.php?proyecto=" . $row["ID_PROYECTO"] . "\" >
                                Soportes Inducción</a></td></tr>";
