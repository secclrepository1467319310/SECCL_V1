...
<h3><b>  se realizará el cierre de programaciones, proyectos, grupos, requerimientos del banco en: </b></h3>
        <div class="desc">
            <div>Días</div>
            <div>Horas</div>
            <div>Minutos</div>
...
<?php
//CIERRE_APLICATIVO:Para cerrar el aplicativo, se debe poner la fecha en la l�nea de c�digo siguiente, pero en verdetalles_poa hay que poner todo de cero.
