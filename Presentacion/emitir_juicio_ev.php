        ...
        <div id="contenedorcito" >
            ...
            <div id="generalidades" class='proyecto'>   
                ...
                <center>
                    ...
                    <br>
                    <fieldset>
                        <legend><strong>Evidencia de Conocimiento</strong></legend>
                                ...
                                <tr>
                                    <?php if ($estado[0] == 0) { ?>
                                        <?php if ($ec[0] == NULL || $ec[0] == 0) { ?>
                                            <td><input type="text" onkeypress="return numeros(event)" size="3" name="vic"></td>
                                            <td><?php echo $opec[0] ?></td>
                                        <?php } else if ($ec[0] < 60) { ?>
                                            <td><input type="text" value="<?php echo $ec[0] ?>" onkeypress="return numeros(event)" size="3" name="vic"></td>
                                            <td></td>
                                        <?php } else if ($ec[0] >= 60 && $opec[0] == 0) { ?>
                                            <td><input type="text" value="<?php echo $ec[0] ?>" onkeypress="return numeros(event)" size="3" name="vic"></td>
                                            <td><input type="text" onkeypress="return numeros(event)" value="<?php echo $opec[0] ?>" size="3" name="opc"></td>
                                        <?php } else { ?>
                                            <td><input type="text"  value="<?php echo $ec[0] ?>" onkeypress="return numeros(event)" size="3" name="vic"></td>
                                            <td><input type="text"  value="<?php echo $opec[0] ?>" onkeypress="return numeros(event)" size="3" name="opc"></td>
                                        <?php } ?>
                                    <?php } else { ?>
                                        <td><?php echo $ec[0] ?></td>
                                        <td><?php echo $opec[0] ?></td>
                    ...
                    <br>
                    <fieldset>
                        <legend><strong>Evidencia de Desempeño</strong></legend>
                                ...
                                <tr>
                                    <?php if ($estado[0] == 0) { ?>
                                        <?php if ($ed[0] == NULL || $ed[0] == 0) { ?>
                                            <td><input type="text" onkeypress="return numeros(event)" size="3" name="vid"></td>
                                            <td><?php echo $oped[0] ?></td>
                                        <?php } else if ($ed[0] < 60) { ?>
                                            <td><input type="text" value="<?php echo $ed[0] ?>" onkeypress="return numeros(event)" size="3" name="vid"></td>
                                            <td></td>
                                        <?php } else if ($ed[0] >= 60 && $oped[0] == 0) { ?>
                                            <td><input type="text" value="<?php echo $ed[0] ?>" onkeypress="return numeros(event)" size="3" name="vid"></td>
                                            <td><input type="text" onkeypress="return numeros(event)" value="<?php echo $oped[0] ?>" size="3" name="opd"></td>
                                        <?php } else { ?>
                                            <td><input type="text"  value="<?php echo $ed[0] ?>" onkeypress="return numeros(event)" size="3" name="vid"></td>
                                            <td><input type="text"  value="<?php echo $oped[0] ?>" onkeypress="return numeros(event)" size="3" name="opd"></td>
                                        <?php } ?>
                                    <?php } else { ?>
                                        <td><?php echo $ed[0] ?></td>
                                        <td><?php echo $oped[0] ?></td>
                    ...
                    <br>
                    <fieldset>
                        <legend><strong>Evidencia de Producto</strong></legend>
                                ...
                                <tr>
                                    <?php if ($estado[0] == 0) { ?>
                                        <?php if ($ep[0] == NULL || $ep[0] == 0) { ?>
                                            <td><input type="text" onkeypress="return numeros(event)" size="3" name="vip"></td>
                                            <td><?php echo $opep[0] ?></td>
                                        <?php } else if ($ep[0] < 60) { ?>
                                            <td><input type="text" value="<?php echo $ep[0] ?>" onkeypress="return numeros(event)" size="3" name="vip"></td>
                                            <td></td>
                                        <?php } else if ($ep[0] >= 60 && $opep[0] == 0) { ?>
                                            <td><input type="text" value="<?php echo $ep[0] ?>" onkeypress="return numeros(event)" size="3" name="vip"></td>
                                            <td><input type="text" onkeypress="return numeros(event)" value="<?php echo $opep[0] ?>" size="3" name="opp"></td>
                                        <?php } else { ?>
                                            <td><input type="text"  value="<?php echo $ep[0] ?>" onkeypress="return numeros(event)" size="3" name="vip"></td>
                                            <td><input type="text"  value="<?php echo $opep[0] ?>" onkeypress="return numeros(event)" size="3" name="opp"></td>
                                        <?php } ?>
                                    <?php } else { ?>
                                        <td><?php echo $ep[0] ?></td>
                                        <td><?php echo $opep[0] ?></td>
                    ...
                    <p><label>
                            <?php if ($estado[0] == 0) { ?>
                            <form name="formmapa" action="verificar_emitir_juicio_ev.php?norma=<?php echo $idn ?>&idca=<?php echo $idca ?>&idplan=<?php echo $plan ?>&accion=4" method="post" accept-charset="UTF-8">
