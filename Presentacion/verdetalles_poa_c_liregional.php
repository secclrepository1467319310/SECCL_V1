        ...
        <div id="">
            ...
            while ($row = oci_fetch_array($statement, OCI_BOTH)) {
                ...
                <table >
                    ...
                    <thead><tr><th><strong>Código Centro:</strong></th><td><?php echo $cen[0]; ?></td><th><strong>Nombre Centro:</strong></th><td><?php echo utf8_encode($nomcen[0]) ?></td><th><strong>Nombre Subdirector:</strong></th><td></td><th><strong>Nombre Responsable PECCL:</strong></th><td></td></tr></thead>
            ...
            <?php
                ...
                $query10 = ("SELECT PRESUPUESTO_ASIGNADO FROM PLAN_ANUAL where ID_PLAN =  '$codiplan'");
                $statement10 = oci_parse($connection, $query10);
                $resp10 = oci_execute($statement10);
                $pasignado = oci_fetch_array($statement10, OCI_BOTH);
                
                $query11 = ("SELECT PRESUPUESTO_FALTANTE FROM PLAN_ANUAL where ID_PLAN =  '$codiplan'");
                $statement11 = oci_parse($connection, $query11);
                $resp11 = oci_execute($statement11);
                $faltante = oci_fetch_array($statement11, OCI_BOTH);
            ...
            <table>
                <tr>
                    <th>Concepto Asesor</th><td><textarea cols="30" name="concepto"  rows="3"><?php echo $concepto[0] ?></textarea></td>
                    <th>Presupuesto Asigando</th><td><input type="text"  name="pres1" value="<?php echo $pasignado[0] ?>"></input></td>
                    <th>Presupuesto por falta de Ejecución</th><td><input type="text"  name="pres2" value="<?php echo $faltante[0] ?>"></input></td>
                </tr>
            </table>                
                </form>
            </center>
            ...
            <form name="f1" accept-charset="UTF-8" method="post">
                ...
                <table id='demotable1'>
                    ...
                    while ($row2 = oci_fetch_array($statement2, OCI_BOTH)) {
                        ...
                        echo "<td>$ $row2[PRESUPUESTO_ASIGNADO]</td>";
                        echo "<td>$ $row2[PRESUPUESTO_FALTANTE]</td>";
