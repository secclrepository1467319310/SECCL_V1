...
!-->
    ...
    <body onload="inicio()">
        ...
        <div id="contenedorcito">
                ...
                <center>
                    <br></br>
                    <strong>FORMATO DE REGISTRO DE PROGRAMACIÓN ANUAL</strong><br></br>
                    <strong>DE EVALUACIÓN Y CERTIFICACIÓN DE COMPETENCIAS LABORALES - PAECCL</strong><br></br>
                    
                    <?php echo '<font><strong>Bienvenido (a) : ', utf8_encode($nom), ' </strong></font>'; ?>
                <br></br>
                
                <p align="justify">
                    En este  módulo el Líder de Certificación de Competencias Laborales – LCCL,
                    una vez aprobadas las áreas claves, debe registrar las diferentes actividades,
                    línea de atención, mesa sectorial, normas de competencia laboral, Esquemas de ECCL,
                    Titulaciones o Perfiles Técnicos, responsables,
                    número de aspirantes a evaluar, número de evaluadores, horas y presupuesto 
                    requerido para adelantar proyectos de Certificación de Competencias 
                    Laborales por otorgamiento y mantenimiento.
                </p>
                
                <br></br>
                <?php echo "De clic en empezar para iniciar el registro de la programacion"?>
                <br></br>
                <center><a href="../Presentacion/guardar_poa.php">Empezar</a></center><br></br>
                </center>
            </div>
        <div class="space">&nbsp;</div>
