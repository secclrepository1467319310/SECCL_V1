...
!-->
    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito" style="height:620px;width:1010px;overflow:scroll;">
                <?php
                    ...
                    <form>
                        ...
                        <center>
                            <table id="demotable1" >
                                ...
                                <?php
                                $query = "SELECT NIT_EMPRESA,NOMBRE_EMPRESA,SIGLA_EMPRESA FROM EMPRESAS_SISTEMA";
                                ...
                                while ($row = oci_fetch_array($statement, OCI_BOTH)) {
                                    ...
                                    $row["NIT_EMPRESA"] . "</font></td>";
                                    echo "<td width=\"\"><font face=\"verdana\">" .
                                    utf8_encode($row["NOMBRE_EMPRESA"]) . "</font></td>";
                                    echo "<td width=\"\"><font face=\"verdana\">" .
                                    utf8_encode($row["SIGLA_EMPRESA"]) . "</font></td>";
                                    echo "<td width=\"\">Ver Ficha</td></tr>";
