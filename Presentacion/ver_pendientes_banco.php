    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center><?php echo '<font><strong>Solicitudes Pendientes</strong></font>'; ?></center>
                ...
                <center>
                    <form><br><br>
                        <center>
                             <a href="?year=2015">Solicitudes pendientes del  2015</a>|
                             <a href="?year=2016">Solicitudes pendientes del  2016</a>
                            <br>
                            Exportar Solicitudes Pendientes <a  class="exportacion"  href="ExpSolicitudesBanco.php?tipo=2"><img src="../images/excel.png" width="26" height="26"></img></a>                      </a>
                            <br/>
                            <br/>
                            <table id="demotable1" >
                                <thead><tr>
                                ...
                                for ($i = 0; $i < $numrowsSelSolicitudes; $i++) {
                                    ...
                                    $sqlSelIdmax = 'SELECT ID_ESTADO_SOLICITUD
                                        ...
                                        WHERE ID_ESTADO_SOLICITUD IN (
                                            ...
                                            AND ID_TIPO_ESTADO_SOLICITUD = 2';
