...
!-->
                    ...
                    <form name="f2" action="guardar_ncl.php" method="post" >
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input name="reg" type="text" size="1" readonly value="<?php echo $reg[0] ?>"></input></td>
                            </tr>
                            <tr>
                                <th>Código de Centro</th>
                                <td><input name="cen" type="text" size="1" readonly value="<?php echo $cen[0] ?>"></input></td>
                            </tr>
                            <tr>
    ...
    <!--                                <td><input type="radio" value="1" name="tp" checked  onclick="deshabilita()"></input>Demanda Social
                                            <input type="radio" value="2" name="tp" onclick="habilita()"></input>Alianza</td></tr>-->
                                </td>
                            <tr>
                                ...
                                <td><input name="nit_empresa" id="nit_empresa" maxlength="9" onKeyPress="return validar(event)" type="text" value="<?php echo $_GET["nit"] ?>">
                                    ...
                                    <input id="val" type="button" value="Validar nit" onkeypress="validar();" class="botones" onClick="window.location = 'validar_nit.php?poa=<?php echo $plan ?>&nit=' + document.getElementById('nit_empresa').value"></input>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input id="val" type="button" value="Cargar Catálogo" onkeypress="validar();" class="botones" onClick="window.location = 'validar_unidad.php?nit=<?php echo $_GET["nit"] ?>&empresa=<?php echo $_GET["empresa"] ?>&sigla=<?php echo $_GET["sigla"] ?>&poa=<?php echo $plan ?>&unidad=' + document.getElementById('unidad').value"></input>
                                </td>
                            </tr>
                        </table>
                        <br>
                        ...
                        if ($unidad == 1)
                        {
                            ...
                            <center>
                                <table id="demotable1" >
                                    ...
                                    <?php
                                    //                                $query = "SELECT m.codigo_mesa CODIGO_MESA,
...
//                                        n.id_norma ID_NORMA
//                                        FROM areas_claves ac 
//                                        INNER JOIN areas_claves_centro acc ON ac.id_area_clave = acc.id_area_clave
//                                        INNER JOIN mesa m ON m.CODIGO_MESA = acc.ID_MESA
//                                        INNER JOIN norma n ON m.CODIGO_MESA = n.CODIGO_MESA
//                                        INNER JOIN normas_clave_centro ncc ON n.CODIGO_NORMA = ncc.CODIGO_NORMA
//                                        WHERE ac.CODIGO_CENTRO = $idc[1] 
//                                            and acc.aprobado_asesor = 1 
//                                            and n.activa=1 
//                                            and acc.periodo = 2014
//                                            and ncc.PERIODO = 2014 
//                                            and ncc.CODIGO_CENTRO = $idc[1]";
                                    ...
                                    $query = "SELECT m.codigo_mesa CODIGO_MESA,
                                        ...
                                        n.titulo_norma TITULO_NORMA ,
                                        TO_CHAR(n.expiracion_norma,'dd/mm/yyyy') AS EXPIRACION,
                                        MONTHS_BETWEEN(TO_DATE(n.expiracion_norma,'dd/mm/yyyy'),TO_DATE(sysdate,'DD/MM/YYYY')) AS MESES,
                                        n.id_norma ID_NORMA
                                        FROM areas_claves ac 
                                        INNER JOIN areas_claves_centro acc ON ac.id_area_clave = acc.id_area_clave
                                        INNER JOIN mesa m ON m.CODIGO_MESA = acc.ID_MESA
                                        ...
                                        WHERE ac.CODIGO_CENTRO = $idc[1] 
                                            and acc.aprobado_asesor = 1 
                                            and n.activa=1 
                                            and acc.periodo = 2016 ORDER BY m.nombre_mesa ASC";
...
//                                        $d = restaFechas($date2, $date1);
                                        ...
                                        $sqlSelect = "SELECT * FROM T_NORMAS_AUTORIZADAS WHERE ID_NORMA = $row[ID_NORMA] AND CODIGO_CENTRO =$cen[CODIGO_CENTRO]  AND ESTADO = '1'";
                                        $objSelect = oci_parse($connection, $sqlSelect);
                                        oci_execute($objSelect);
                                        $numRows = oci_fetch_all($objSelect, $rows);

                                        if ($row["MESES"] > 3 || $numRows > 0) {
                                            ?>
                                        ...
                                        {
                                            //aqui va el disabled, se desactiva momentaneamente
                                            ?>
                                            <td style=" color: red;">
                                                NCL Próxima a vencer
                                            </td>
                                            </tr>
                                            <input type="hidden" name="usuario" value="<?php echo $login ?>" ></input>       
                                            <?php
