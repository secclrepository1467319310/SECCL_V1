...
if ($_SESSION['logged'] == 'yes') {    
    header("Location:Sesion/sesionlogin.php");
}
?>
<!DOCTYPE HTML>
<html>
...
//}
		...
		$().ready(function() {
				...
				pattern:function(){
                                	var pNL="^[0-9a-zA-Z\-\_]+$";
                                	var pN="^[0-9]*$";
	                                return $("[name='t_doc']").val()==2?pN:pNL;
                            }
            ...
            <div class="total">
                ...
                <div id="menu">
                    <ul id="nav">
                        ...
                        <li class="top"><a href="./Presentacion/ofertaECCL.php" class="top_link top_link"><span>OFERTA ECCL</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="total" style="height: 680px;">
            ...
            <div class="columna"  style="width:780px; ">
                ...
                <p align="justify"><br />
                    ...
                    <br/>   
                    <br/>   
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/ookU2G-JQiw" frameborder="0" allowfullscreen></iframe>
                </p></div>
            <div class="espacio">&nbsp;</div>
            <br></br>
            <form id="formulario2" method="post" action="Presentacion/registrar_usuario.php" 
                  name="formulario2" onSubmit="return validar()" accept-charset="ISO-8859-1">
